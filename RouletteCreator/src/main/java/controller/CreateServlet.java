...
//		String[] itemProbability = request.getParameterValues("item_probability[]");
//		
//		request.setAttribute("name", itemNames);
//		request.setAttribute("itemProbability", itemProbability);
//		
//		RequestDispatcher dispatcher = request.getRequestDispatcher("/ExecutionServlet");
